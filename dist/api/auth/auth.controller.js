    ...
    constructor() {
        ...
        this.signup = (request, response, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Create user, tokens
                const account = yield (0, accounts_service_1.createAccount)(data.email, data.password, data.birthday);
        ...
        this.login = (request, response, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const data = request.body.data;
                if (!data.identifier)
                    throw new error_1.InvalidInputError('identifier');
                if (!data.password)
                    throw new error_1.InvalidInputError('password');
                // Fetch account and verify it exists
                const account = yield (0, accounts_service_1.findAccountByEmail)(data.identifier);
